        ...
        zIndex: function(b) {
            ...
            if (this.length)
                for (var d, e, c = a(this[0]); c.length && c[0] !== document;) {
                    if (("absolute" == (d = c.css("position")) || "relative" == d || "fixed" == d) && (e = parseInt(c.css("zIndex")), !isNaN(e) && 0 != e)) return e;
                    c = c.parent()
                }
            return 0
        }
...
function(a) {
    ...
    a.fn.remove = function(c, d) {
        return this.each(function() {
            return d || c && !a.filter(c, [this]).length || a("*", this).add(this).each(function() {
        ...
        var g = new c;
        g.options = a.extend({}, g.options), a[e][b].prototype = a.extend(!0, g, {
            namespace: e,
            widgetName: b,
        ...
        a.fn[b] = function(d) {
            var e = "string" == typeof d,
                ...
                g = this;
            return d = !e && f.length ? a.extend.apply(null, [!0, d].concat(f)) : d, e && "_" === d.substring(0, 1) ? g : (e ? this.each(function() {
                var c = a.data(this, b),
                    e = c && a.isFunction(c[d]) ? c[d].apply(c, f) : c;
                if (e !== c && void 0 !== e) return g = e, !1
            }) : this.each(function() {
                var e = a.data(this, b);
                e ? (d && e.option(d), e._init()) : a.data(this, b, new c(d, this))
            }), g)
        }
        ...
        _createWidget: function(b, c) {
            this.element = a(c).data(this.widgetName, this), this.options = a.extend(!0, {}, this.options, a.metadata && a.metadata.get(c)[this.widgetName], b);
            var d = this;
        ...
        option: function(b, c) {
            var d = b,
                e = this;
            if (0 === arguments.length) return a.extend({}, e.options);
            if ("string" == typeof b) {
        ...
        _trigger: function(b, c, d) {
            ...
            if (c = a.Event(c), c.type = (b === this.widgetEventPrefix ? b : this.widgetEventPrefix + b).toLowerCase(), d = d || {}, c.originalEvent)
                for (var g, f = a.event.props.length; f;) g = a.event.props[--f], c[g] = c.originalEvent[g];
            return this.element.trigger(c, d), !(a.isFunction(e) && !1 === e.call(this.element[0], c, d) || c.isDefaultPrevented())
        }
    }
}(jQuery),
function(a) {
    a.widget("ui.mouse", {
        ...
        _mouseInit: function() {
            ...
            this.element.bind("mousedown." + this.widgetName, function(b) {
                ...
                if (a._preventClickEvent) return a._preventClickEvent = !1, b.stopImmediatePropagation(), !1
            }), this.started = !1
        },
        ...
        _mouseDown: function(b) {
            if (b.originalEvent = b.originalEvent || {}, !b.originalEvent.mouseHandled) {
                ...
                return !(d && !e && this._mouseCapture(b)) || (this.mouseDelayMet = !this.options.delay, this.mouseDelayMet || (this._mouseDelayTimer = setTimeout(function() {
                    c.mouseDelayMet = !0
                }, this.options.delay)), this._mouseDistanceMet(b) && this._mouseDelayMet(b) && (this._mouseStarted = !1 !== this._mouseStart(b), !this._mouseStarted) ? (b.preventDefault(), !0) : (this._mouseMoveDelegate = function(a) {
                    return c._mouseMove(a)
                }, this._mouseUpDelegate = function(a) {
                    return c._mouseUp(a)
                }, a(document).bind("mousemove." + this.widgetName, this._mouseMoveDelegate).bind("mouseup." + this.widgetName, this._mouseUpDelegate), a.browser.safari || b.preventDefault(), b.originalEvent.mouseHandled = !0, !0))
            }
        },
        _mouseMove: function(b) {
            return a.browser.msie && !b.button ? this._mouseUp(b) : this._mouseStarted ? (this._mouseDrag(b), b.preventDefault()) : (this._mouseDistanceMet(b) && this._mouseDelayMet(b) && (this._mouseStarted = !1 !== this._mouseStart(this._mouseDownEvent, b), this._mouseStarted ? this._mouseDrag(b) : this._mouseUp(b)), !this._mouseStarted)
        },
        _mouseUp: function(b) {
            return a(document).unbind("mousemove." + this.widgetName, this._mouseMoveDelegate).unbind("mouseup." + this.widgetName, this._mouseUpDelegate), this._mouseStarted && (this._mouseStarted = !1, this._preventClickEvent = b.target == this._mouseDownEvent.target, this._mouseStop(b)), !1
        },
...
function(a) {
    a.widget("ui.draggable", a.ui.mouse, {
        ...
        _mouseStop: function(b) {
            var c = !1;
            if (a.ui.ddmanager && !this.options.dropBehaviour && (c = a.ui.ddmanager.drop(this, b)), this.dropped && (c = this.dropped, this.dropped = !1), !this.element[0] || !this.element[0].parentNode) return !1;
        ...
        _createHelper: function(b) {
            var c = this.options,
                d = a.isFunction(c.helper) ? a(c.helper.apply(this.element[0], [b])) : "clone" == c.helper ? this.element.clone() : this.element;
        ...
        start: function(b, c) {
            var d = a(this).data("draggable").options;
            a(!0 === d.iframeFix ? "iframe" : d.iframeFix).each(function() {
    ...
    a.widget("ui.droppable", {
        ...
        switch (d) {
            ...
            case "pointer":
                ...
                return a.ui.isOver(n, m, k, i, c.proportions.height, c.proportions.width);
            case "touch":
...
function(a) {
    a.widget("ui.resizable", a.ui.mouse, {
        ...
        _mouseDrag: function(b) {
            ...
            a.browser.msie && a.browser.version, this.sizeDiff;
            return (this._aspectRatio || b.shiftKey) && (l = this._updateRatio(l, b)), l = this._respectSize(l, b), this._propagate("resize", b), c.css({
        ...
        _mouseStop: function(b) {
            ...
            if (this._helper) {
                var e = this._proportionallyResizeElements,
                    ...
                    i = {
                        width: d.size.width - h,
                        height: d.size.height - g
                    },
        ...
        _updateRatio: function(a, b) {
            var d = (this.options, this.position),
                e = this.size,
                f = this.axis;
            return a.height ? a.width = e.height * this.aspectRatio : a.width && (a.height = e.width / this.aspectRatio), "sw" == f && (a.left = d.left + (e.width - a.width), a.top = null), "nw" == f && (a.top = d.top + (e.height - a.height), a.left = d.left + (e.width - a.width)), a
        },
        _respectSize: function(a, b) {
            var e = (this.helper, this.options),
                g = (this._aspectRatio || b.shiftKey, this.axis),
                h = c(a.width) && e.maxWidth && e.maxWidth < a.width,
                i = c(a.height) && e.maxHeight && e.maxHeight < a.height,
                j = c(a.width) && e.minWidth && e.minWidth > a.width,
                k = c(a.height) && e.minHeight && e.minHeight > a.height;
                ...
                for (var c = this.helper || this.element, d = 0; d < this._proportionallyResizeElements.length; d++) {
                    ...
                    if (!this.borderDif) {
                        ...
                        this.borderDif = a.map(f, function(a, b) {
                            return (parseInt(a, 10) || 0) + (parseInt(g[b], 10) || 0)
                        })
                    }
        ...
        start: function(b, c) {
            ...
            "object" != typeof e.alsoResize || e.alsoResize.parentNode ? f(e.alsoResize) : e.alsoResize.length ? (e.alsoResize = e.alsoResize[0], f(e.alsoResize)) : a.each(e.alsoResize, function(a, b) {
                f(a)
            })
        },
        resize: function(b, c) {
                ...
                i = function(b, c) {
                    a(b).each(function() {
                        var b = a(this),
                            ...
                            f = {},
                            g = c && c.length ? c : ["width", "height", "top", "left"];
                        a.each(g || ["width", "height", "top", "left"], function(a, b) {
                            var c = (e[b] || 0) + (h[b] || 0);
                            c && c >= 0 && (f[b] = c || null)
                        }), /relative/.test(b.css("position")) && a.browser.opera && (d._revertToRelativePosition = !0, b.css({
                            position: "absolute",
                            top: "auto",
                            left: "auto"
                        })), b.css(f)
        ...
        stop: function(b, c) {
            var d = a(this).data("resizable");
            d._revertToRelativePosition && a.browser.opera && (d._revertToRelativePosition = !1, el.css({
                position: "relative"
        ...
        resize: function(b, c) {
            ...
            var m = Math.abs((d._helper, d.offset.left - k.left + d.sizeDiff.width)),
...
function(a) {
    a.widget("ui.sortable", a.ui.mouse, {
        ...
        _mouseCapture: function(b, c) {
            ...
            if (a.data(b.target, "sortable-item") == e && (d = a(b.target)), !d) return !1;
        ...
        _mouseDrag: function(b) {
            ...
            for (var e = this.items.length - 1; e >= 0; e--) {
                ...
                if (h && !(g == this.currentItem[0] || this.placeholder[1 == h ? "next" : "prev"]()[0] == g || a.ui.contains(this.placeholder[0], g) || "semi-dynamic" == this.options.type && a.ui.contains(this.element[0], g))) {
        ...
        cancel: function() {
            var b = this;
            if (this.dragging) {
                this._mouseUp(), "original" == this.options.helper ? this.currentItem.css(this._storedCSS).removeClass("ui-sortable-helper") : this.currentItem.show();
            ...
            return this.placeholder[0].parentNode && this.placeholder[0].parentNode.removeChild(this.placeholder[0]), "original" != this.options.helper && this.helper && this.helper[0].parentNode && this.helper.remove(), a.extend(this, {
                helper: null,
                dragging: !1,
                reverting: !1,
                _noFinalSort: null
        ...
        _refreshItems: function(b) {
            ...
            for (var g = e.length - 1; g >= 0; g--)
                for (var k = e[g][1], l = e[g][0], i = 0, m = l.length; i < m; i++) {
                    var n = a(l[i]);
                    n.data("sortable-item", k), c.push({
                        item: n,
                        instance: k,
                        width: 0,
                        height: 0,
...
}(jQuery), jQuery.effects || function(a) {
        function b(b) {
            var c;
            return b && b.constructor == Array && 3 == b.length ? b : (c = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/.exec(b)) ? [parseInt(c[1], 10), parseInt(c[2], 10), parseInt(c[3], 10)] : (c = /rgb\(\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*\)/.exec(b)) ? [2.55 * parseFloat(c[1]), 2.55 * parseFloat(c[2]), 2.55 * parseFloat(c[3])] : (c = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/.exec(b)) ? [parseInt(c[1], 16), parseInt(c[2], 16), parseInt(c[3], 16)] : (c = /#([a-fA-F0-9])([a-fA-F0-9])([a-fA-F0-9])/.exec(b)) ? [parseInt(c[1] + c[1], 16), parseInt(c[2] + c[2], 16), parseInt(c[3] + c[3], 16)] : (c = /rgba\(0, 0, 0, 0\)/.exec(b)) ? d.transparent : d[a.trim(b).toLowerCase()]
        }

        function c(c, d) {
            var e;
            do {
                if ("" != (e = a.curCSS(c, d)) && "transparent" != e || a.nodeName(c, "body")) break;
                d = "backgroundColor"
        ...
        function g() {
            ...
            if (a && a.length && a[0] && a[a[0]])
                ...
                for (c in a) "string" == typeof a[c] && (b[c] = a[c]);
            return b
        }

        function h(b) {
            var c, d;
            for (c in b)(null == (d = b[c]) || a.isFunction(d) || c in f || /scrollbar/.test(c) || !/color/i.test(c) && isNaN(parseFloat(d))) && delete b[c];
            return b
        }
        ...
        function j(b, c, d, e) {
            return "object" == typeof b && (e = c, d = null, c = b, b = c.effect), a.isFunction(c) && (e = c, d = null, c = {}), a.isFunction(d) && (e = d, d = null), ("number" == typeof c || a.fx.speeds[c]) && (e = d, d = c, c = {}), c = c || {}, d = d || c.duration, d = a.fx.off ? 0 : "number" == typeof d ? d : a.fx.speeds[d] || a.fx.speeds._default, e = e || c.complete, [b, c, d, e]
        }
        a.effects = {}, a.each(["backgroundColor", "borderBottomColor", "borderLeftColor", "borderRightColor", "borderTopColor", "color", "outlineColor"], function(d, e) {
        ...
        a.effects.animateClass = function(b, c, d, f) {
            return a.isFunction(d) && (f = d, d = null), this.each(function() {
                var m, j = a(this),
                    k = j.attr("style") || " ",
                    l = h(g.call(this)),
                    n = j.attr("className");
                a.each(e, function(a, c) {
                    b[c] && j[c + "Class"](b[c])
                }), m = h(g.call(this)), j.attr("className", n), j.animate(i(l, m), c, d, function() {
                    a.each(e, function(a, c) {
                        b[c] && j[c + "Class"](b[c])
                    }), "object" == typeof j.attr("style") ? (j.attr("style").cssText = "", j.attr("style").cssText = k) : j.attr("style", k), f && f.apply(this, arguments)
                })
            })
        }, a.fn.extend({
            ...
            toggleClass: function(b, c, d, e, f) {
                return "boolean" == typeof c || void 0 === c ? d ? a.effects.animateClass.apply(this, [c ? {
                    add: b
                } : {
                    remove: b
            ...
            effect: function(b, c, d, e) {
                var f = j.apply(this, arguments),
                    ...
                    h = a.effects[b];
                return h && !a.fx.off ? h.call(this, g) : this
            },
            _show: a.fn.show,
            show: function(b) {
                if (!b || "number" == typeof b || a.fx.speeds[b]) return this._show.apply(this, arguments);
                var c = j.apply(this, arguments);
                return c[1].mode = "show", this.effect.apply(this, c)
            },
            _hide: a.fn.hide,
            hide: function(b) {
                if (!b || "number" == typeof b || a.fx.speeds[b]) return this._hide.apply(this, arguments);
                var c = j.apply(this, arguments);
                return c[1].mode = "hide", this.effect.apply(this, c)
            },
            __toggle: a.fn.toggle,
            toggle: function(b) {
                if (!b || "number" == typeof b || a.fx.speeds[b] || "boolean" == typeof b || a.isFunction(b)) return this.__toggle.apply(this, arguments);
                var c = j.apply(this, arguments);
    ...
    function(a) {
        a.effects.puff = function(b) {
            ...
            return this.queue(function() {
                var c = a(this),
                    d = ["position", "top", "left", "width", "height", "overflow", "opacity"],
    ...
    function(a) {
        a.widget("ui.accordion", {
            ...
            _create: function() {
                var b = this.options,
                    c = this;
                if (this.running = 0, this.element.addClass("ui-accordion ui-widget ui-helper-reset"), this.element.children("li").addClass("ui-accordion-li-fix"), this.headers = this.element.find(b.header).addClass("ui-accordion-header ui-helper-reset ui-state-default ui-corner-all").bind("mouseenter.accordion", function() {
                    ...
                    }), this.headers.next().addClass("ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom"), b.navigation) {
                    var d = this.element.find("a").filter(b.navigationFilter);
                    if (d.length) {
                        var e = d.closest(".ui-accordion-header");
                        e.length ? this.active = e : this.active = d.closest(".ui-accordion-content").prev()
                    }
                }
                this.active = this._findActive(this.active || b.active).toggleClass("ui-state-default").toggleClass("ui-state-active").toggleClass("ui-corner-all").toggleClass("ui-corner-top"), this.active.next().addClass("ui-accordion-content-active"), this._createIcons(), this.resize(), this.element.attr("role", "tablist"), this.headers.attr("role", "tab").bind("keydown", function(a) {
                    return c._keydown(a)
                }).next().attr("role", "tabpanel"), this.headers.not(this.active || "").attr("aria-expanded", "false").attr("tabIndex", "-1").next().hide(), this.active.length ? this.active.attr("aria-expanded", "true").attr("tabIndex", "0") : this.headers.eq(0).attr("tabIndex", "0"), a.browser.safari || this.headers.find("a").attr("tabIndex", "-1"), b.event && this.headers.bind(b.event + ".accordion", function(a) {
                    c._clickHandler.call(c, a, this), a.preventDefault()
                })
            },
            _createIcons: function() {
                var b = this.options;
                b.icons && (a("<span/>").addClass("ui-icon " + b.icons.header).prependTo(this.headers), this.active.find(".ui-icon").toggleClass(b.icons.header).toggleClass(b.icons.headerSelected), this.element.addClass("ui-accordion-icons"))
            },
            ...
            destroy: function() {
                var a = this.options;
                this.element.removeClass("ui-accordion ui-widget ui-helper-reset").removeAttr("role").unbind(".accordion").removeData("accordion"), this.headers.unbind(".accordion").removeClass("ui-accordion-header ui-helper-reset ui-state-default ui-corner-all ui-state-active ui-corner-top").removeAttr("role").removeAttr("aria-expanded").removeAttr("tabIndex"), this.headers.find("a").removeAttr("tabIndex"), this._destroyIcons();
                var b = this.headers.next().css("display", "").removeAttr("role").removeClass("ui-helper-reset ui-widget-content ui-corner-bottom ui-accordion-content ui-accordion-content-active");
                return (a.autoHeight || a.fillHeight) && b.css("height", ""), this
            },
            _setOption: function(b, c) {
                a.Widget.prototype._setOption.apply(this, arguments), "active" == b && this.activate(c), "icons" == b && (this._destroyIcons(), c && this._createIcons())
            },
            _keydown: function(b) {
                var c = this.options,
                    d = a.ui.keyCode;
                if (!(c.disabled || b.altKey || b.ctrlKey)) {
                    ...
                    return !g || (a(b.target).attr("tabIndex", "-1"), a(g).attr("tabIndex", "0"), g.focus(), !1)
                }
            },
            resize: function() {
            ...
            _clickHandler: function(b, c) {
                ...
                if (!d.disabled) {
                    if (!b.target) {
                        ...
                        this.active.removeClass("ui-state-active ui-corner-top").addClass("ui-state-default ui-corner-all").find(".ui-icon").removeClass(d.icons.headerSelected).addClass(d.icons.header), this.active.next().addClass("ui-accordion-content-active");
                    ...
                    var h = a(b.currentTarget || c),
                        i = h[0] == this.active[0];
                    if (d.active = (!d.collapsible || !i) && a(".ui-accordion-header", this.element).index(h), !(this.running || !d.collapsible && i)) {
                        this.active.removeClass("ui-state-active ui-corner-top").addClass("ui-state-default ui-corner-all").find(".ui-icon").removeClass(d.icons.headerSelected).addClass(d.icons.header), i || (h.removeClass("ui-state-default ui-corner-all").addClass("ui-state-active ui-corner-top").find(".ui-icon").removeClass(d.icons.header).addClass(d.icons.headerSelected), h.next().addClass("ui-accordion-content-active"));
                        var g = h.next(),
                            e = this.active.next(),
                            f = {
                                options: d,
                            ...
                            j = this.headers.index(this.active[0]) > this.headers.index(h[0]);
                        this.active = i ? a([]) : h, this._toggle(g, e, f, i, j)
                    }
                }
            },
            _toggle: function(b, c, d, e, f) {
                var g = this.options,
                    h = this;
                this.toShow = b, this.toHide = c, this.data = d;
                var i = function() {
                    if (h) return h._completed.apply(h, arguments)
                };
                if (this._trigger("changestart", null, this.data), this.running = 0 === c.size() ? b.size() : c.size(), g.animated) {
                    var j = {};
                    j = g.collapsible && e ? {
                        toShow: a([]),
                        toHide: c,
                        ...
                        down: f,
                        autoHeight: g.autoHeight || g.fillSpace
                    }, g.proxied || (g.proxied = g.animated), g.proxiedDuration || (g.proxiedDuration = g.duration), g.animated = a.isFunction(g.proxied) ? g.proxied(j) : g.proxied, g.duration = a.isFunction(g.proxiedDuration) ? g.proxiedDuration(j) : g.proxiedDuration;
                ...
                } else g.collapsible && e ? b.toggle() : (c.hide(), b.show()), i(!0);
                c.prev().attr("aria-expanded", "false").attr("tabIndex", "-1").blur(), b.prev().attr("aria-expanded", "true").attr("tabIndex", "0").focus()
            },
            _completed: function(a) {
                var b = this.options;
                this.running = a ? 0 : --this.running, this.running || (b.clearStyle && this.toShow.add(this.toHide).css({
                    height: "",
                    overflow: ""
            ...
            animations: {
                slide: function(b, c) {
                    ...
                    i = j[0].style.width, j.width(parseInt(j.parent().width(), 10) - parseInt(j.css("paddingLeft"), 10) - parseInt(j.css("paddingRight"), 10) - (parseInt(j.css("borderLeftWidth"), 10) || 0) - (parseInt(j.css("borderRightWidth"), 10) || 0)), a.each(h, function(c, d) {
                        ...
                        easing: b.easing,
                        complete: function() {
                            b.autoHeight || b.toShow.css("height", ""), b.toShow.css("width", i), b.toShow.css({
                                overflow: d
                            }), b.complete()
                        }
                    })
    ...
    function(a) {
        a.widget("ui.autocomplete", {
            ...
            _create: function() {
                ...
                this.element.addClass("ui-autocomplete-input").attr("autocomplete", "off").attr({
                    ...
                    switch (c.keyCode) {
                        ...
                        case d.ENTER:
                        case d.NUMPAD_ENTER:
                            b.menu.active && c.preventDefault();
                        case d.TAB:
                    ...
                    selected: function(a, d) {
                        ...
                        !1 !== b._trigger("select", a, {
                            item: e
                        }) && b.element.val(e.value), b.close(a);
                        var f = b.previous;
                        b.element[0] !== c.activeElement && (b.element.focus(), b.previous = f), b.selectedItem = e
                    },
                    blur: function(a, c) {
            ...
            _setOption: function(b) {
                a.Widget.prototype._setOption.apply(this, arguments), "source" === b && this._initSource()
            },
            _initSource: function() {
                var b, c;
                a.isArray(this.options.source) ? (b = this.options.source, this.source = function(c, d) {
                    d(a.ui.autocomplete.filter(b, c.term))
                }) : "string" == typeof this.options.source ? (c = this.options.source, this.source = function(b, d) {
                    a.getJSON(c, b, d)
                }) : this.source = this.options.source
            },
            search: function(a, b) {
                return a = null != a ? a : this.element.val(), a.length < this.options.minLength ? this.close(b) : (clearTimeout(this.closing), !1 !== this._trigger("search") ? this._search(a) : void 0)
            },
            _search: function(a) {
                this.term = this.element.addClass("ui-autocomplete-loading").val(), this.source({
                    term: a
                }, this.response)
            },
            _response: function(a) {
                a.length ? (a = this._normalize(a), this._suggest(a), this._trigger("open")) : this.close(), this.element.removeClass("ui-autocomplete-loading")
            },
            close: function(a) {
                clearTimeout(this.closing), this.menu.element.is(":visible") && (this._trigger("close", a), this.menu.element.hide(), this.menu.deactivate())
            },
            _change: function(a) {
            ...
            _suggest: function(a) {
                var c, d, b = this.menu.element.empty().zIndex(this.element.zIndex() + 1);
                this._renderMenu(b, a), this.menu.deactivate(), this.menu.refresh(), this.menu.element.show().position({
                    my: "left top",
                    at: "left bottom",
                    of: this.element,
                    collision: "none"
                }), c = b.width("").width(), d = this.element.width(), b.width(Math.max(c, d))
            },
    ...
    function(a) {
        a.widget("ui.menu", {
            ...
            nextPage: function(b) {
                if (this.hasScroll()) {
                    if (!this.active || this.last()) return void this.activate(b, this.element.children(":first"));
            ...
            previousPage: function(b) {
                if (this.hasScroll()) {
                    if (!this.active || this.first()) return void this.activate(b, this.element.children(":last"));
                    var c = this.active.offset().top,
                        d = this.element.height();
    ...
    function(a) {
        var b, c = "ui-button ui-widget ui-state-default ui-corner-all",
            e = "ui-button-icons-only ui-button-icon-only ui-button-text-icons ui-button-text-icon ui-button-text-only",
            f = function(b) {
        ...
        a.widget("ui.button", {
            ...
            _create: function() {
                ...
                var d = this,
                    ...
                    j = "ui-state-focus";
                null === e.label && (e.label = this.buttonElement.html()), this.element.is(":disabled") && (e.disabled = !0), this.buttonElement.addClass(c).attr("role", "button").bind("mouseenter.button", function() {
                    e.disabled || (a(this).addClass("ui-state-hover"), this === b && a(this).addClass("ui-state-active"))
                }).bind("mouseleave.button", function() {
                    e.disabled || a(this).removeClass(i)
                    ...
                    a(this).toggleClass("ui-state-active"), d.buttonElement.attr("aria-pressed", d.element[0].checked)
                }) : "radio" === this.type ? this.buttonElement.bind("click.button", function() {
                    if (e.disabled) return !1;
                    a(this).addClass("ui-state-active"), d.buttonElement.attr("aria-pressed", !0);
                    var b = d.element[0];
                    ...
                    if (e.disabled) return !1;
                    a(this).addClass("ui-state-active"), b = this, a(document).one("mouseup", function() {
                        b = null
                    })
            ...
            destroy: function() {
                this.element.removeClass("ui-helper-hidden-accessible"), this.buttonElement.removeClass(c + " ui-state-hover ui-state-active  " + e).removeAttr("role").removeAttr("aria-pressed").html(this.buttonElement.find(".ui-button-text").html()), this.hasTitle || this.buttonElement.removeAttr("title"), a.Widget.prototype.destroy.call(this)
            },
            _setOption: function(b, c) {
            ...
            refresh: function() {
                ...
                b !== this.options.disabled && this._setOption("disabled", b), "radio" === this.type ? g(this.element[0]).each(function() {
            ...
            _resetButton: function() {
                ...
                var b = this.buttonElement.removeClass(e),
                    c = a("<span></span>").addClass("ui-button-text").html(this.options.label).appendTo(b.empty()).text(),
                    d = this.options.icons,
                    f = d.primary && d.secondary;
                d.primary || d.secondary ? (b.addClass("ui-button-text-icon" + (f ? "s" : "")), d.primary && b.prepend("<span class='ui-button-icon-primary ui-icon " + d.primary + "'></span>"), d.secondary && b.append("<span class='ui-button-icon-secondary ui-icon " + d.secondary + "'></span>"), this.options.text || (b.addClass(f ? "ui-button-icons-only" : "ui-button-icon-only").removeClass("ui-button-text-icons ui-button-text-icon"), this.hasTitle || b.attr("title", c))) : b.addClass("ui-button-text-only")
            }
    ...
    function($) {
        ...
        $.extend(Datepicker.prototype, {
            ...
            _newInst: function(a, b) {
                return {
                    ...
                    drawYear: 0,
                    inline: b,
                    dpDiv: b ? $('<div class="' + this._inlineClass + ' ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all"></div>') : this.dpDiv
                }
            },
            _connectDatepicker: function(a, b) {
                ...
                }), this._autoSize(b), $.data(a, PROP_NAME, b))
            },
            ...
            _optionDatepicker: function(a, b, c) {
                ...
                if ("string" == typeof b && (e = {}, e[b] = c), d) {
                    ...
                    extendRemove(d.settings, e), this._attachments($(a), d), this._autoSize(d), this._setDateDatepicker(a, f), this._updateDatepicker(d)
                }
            },
            ...
            _doKeyDown: function(a) {
                ...
                if (b._keyEvent = !0, $.datepicker._datepickerShowing) switch (a.keyCode) {
                    case 9:
                        ...
                        break;
                    case 13:
                        var e = $("td." + $.datepicker._dayOverClass, b.dpDiv).add($("td." + $.datepicker._currentClass, b.dpDiv));
                        return e[0] ? $.datepicker._selectDay(a.target, b.selectedMonth, b.selectedYear, e[0]) : $.datepicker._hideDatepicker(), !1;
                    case 27:
            ...
            _doKeyPress: function(a) {
                ...
                if ($.datepicker._get(b, "constrainInput")) {
                    var c = $.datepicker._possibleChars($.datepicker._get(b, "dateFormat")),
                        d = String.fromCharCode(void 0 == a.charCode ? a.keyCode : a.charCode);
            ...
            _doKeyUp: function(a) {
                ...
                if (b.input.val() != b.lastVal) try {
                    $.datepicker.parseDate($.datepicker._get(b, "dateFormat"), b.input ? b.input.val() : null, $.datepicker._getFormatConfig(b)) && ($.datepicker._setDateFromField(b), $.datepicker._updateAlternate(b), $.datepicker._updateDatepicker(b))
                } catch (a) {
                    $.datepicker.log(a)
                }
                return !0
            ...
            _showDatepicker: function(a) {
                if (a = a.target || a, "input" != a.nodeName.toLowerCase() && (a = $("input", a.parentNode)[0]), !$.datepicker._isDisabledDatepicker(a) && $.datepicker._lastInput != a) {
                    ...
                    extendRemove(b.settings, c ? c.apply(a, [a, b]) : {}), b.lastVal = null, $.datepicker._lastInput = a, $.datepicker._setDateFromField(b), $.datepicker._inDialog && (a.value = ""), $.datepicker._pos || ($.datepicker._pos = $.datepicker._findPos(a), $.datepicker._pos[1] += a.offsetHeight);
                    var d = !1;
                    $(a).parents().each(function() {
                        return !(d |= "fixed" == $(this).css("position"))
                    }), d && $.browser.opera && ($.datepicker._pos[0] -= document.documentElement.scrollLeft, $.datepicker._pos[1] -= document.documentElement.scrollTop);
                    var e = {
                        left: $.datepicker._pos[0],
                        top: $.datepicker._pos[1]
                    };
                    if ($.datepicker._pos = null, b.dpDiv.css({
                            position: "absolute",
                            display: "block",
                            top: "-1000px"
                        }), $.datepicker._updateDatepicker(b), e = $.datepicker._checkOffset(b, e, d), b.dpDiv.css({
                        ...
                        var f = $.datepicker._get(b, "showAnim"),
                            g = $.datepicker._get(b, "duration"),
                            h = function() {
                                $.datepicker._datepickerShowing = !0;
                                var a = $.datepicker._getBorders(b.dpDiv);
                        ...
                        b.dpDiv.zIndex($(a).zIndex() + 1), $.effects && $.effects[f] ? b.dpDiv.show(f, $.datepicker._get(b, "showOptions"), g, h) : b.dpDiv[f || "show"](f ? g : null, h), f && g || h(), b.input.is(":visible") && !b.input.is(":disabled") && b.input.focus(), $.datepicker._curInst = b
                    }
                }
            },
            _updateDatepicker: function(a) {
                var b = this,
                    c = $.datepicker._getBorders(a.dpDiv);
                a.dpDiv.empty().append(this._generateHTML(a)).find("iframe.ui-datepicker-cover").css({
                    ...
                    b._isDisabledDatepicker(a.inline ? a.dpDiv.parent()[0] : a.input[0]) || ($(this).parents(".ui-datepicker-calendar").find("a").removeClass("ui-state-hover"), $(this).addClass("ui-state-hover"), -1 != this.className.indexOf("ui-datepicker-prev") && $(this).addClass("ui-datepicker-prev-hover"), -1 != this.className.indexOf("ui-datepicker-next") && $(this).addClass("ui-datepicker-next-hover"))
                }).end().find("." + this._dayOverClass + " a").trigger("mouseover").end();
                var d = this._getNumberOfMonths(a),
                    e = d[1];
                e > 1 ? a.dpDiv.addClass("ui-datepicker-multi-" + e).css("width", 17 * e + "em") : a.dpDiv.removeClass("ui-datepicker-multi-2 ui-datepicker-multi-3 ui-datepicker-multi-4").width(""), a.dpDiv[(1 != d[0] || 1 != d[1] ? "add" : "remove") + "Class"]("ui-datepicker-multi"), a.dpDiv[(this._get(a, "isRTL") ? "add" : "remove") + "Class"]("ui-datepicker-rtl"), a == $.datepicker._curInst && $.datepicker._datepickerShowing && a.input && a.input.is(":visible") && !a.input.is(":disabled") && a.input.focus()
            },
            ...
            _hideDatepicker: function(a) {
                ...
                if (b && (!a || b == $.data(a, PROP_NAME)) && this._datepickerShowing) {
                    ...
                    $.effects && $.effects[c] ? b.dpDiv.hide(c, $.datepicker._get(b, "showOptions"), d, e) : b.dpDiv["slideDown" == c ? "slideUp" : "fadeIn" == c ? "fadeOut" : "hide"](c ? d : null, e), c || e();
                    var f = this._get(b, "onClose");
                    f && f.apply(b.input ? b.input[0] : null, [b.input ? b.input.val() : "", b]), this._datepickerShowing = !1, this._lastInput = null, this._inDialog && (this._dialogInput.css({
                        position: "absolute",
                        left: "0",
                        top: "-100px"
            ...
            _checkExternalClick: function(a) {
                if ($.datepicker._curInst) {
                    var b = $(a.target);
                    b[0].id == $.datepicker._mainDivId || 0 != b.parents("#" + $.datepicker._mainDivId).length || b.hasClass($.datepicker.markerClassName) || b.hasClass($.datepicker._triggerClass) || !$.datepicker._datepickerShowing || $.datepicker._inDialog && $.blockUI || $.datepicker._hideDatepicker()
                }
            },
            ...
            _selectMonthYear: function(a, b, c) {
                var d = $(a),
                    e = this._getInst(d[0]);
                e._selectingMonthYear = !1, e["selected" + ("M" == c ? "Month" : "Year")] = e["draw" + ("M" == c ? "Month" : "Year")] = parseInt(b.options[b.selectedIndex].value, 10), this._notifyChange(e), this._adjustDate(d)
            },
            _clickMonthYear: function(a) {
                var b = $(a),
                    c = this._getInst(b[0]);
                c.input && c._selectingMonthYear && !$.browser.msie && c.input.focus(), c._selectingMonthYear = !c._selectingMonthYear
            },
            ...
            parseDate: function(a, b, c) {
                ...
                if ("" == (b = "object" == typeof b ? b.toString() : b + "")) return null;
                for (var d = (c ? c.shortYearCutoff : null) || this._defaults.shortYearCutoff, e = (c ? c.dayNamesShort : null) || this._defaults.dayNamesShort, f = (c ? c.dayNames : null) || this._defaults.dayNames, g = (c ? c.monthNamesShort : null) || this._defaults.monthNamesShort, h = (c ? c.monthNames : null) || this._defaults.monthNames, i = -1, j = -1, k = -1, l = -1, m = !1, n = function(b) {
                        var c = s + 1 < a.length && a.charAt(s + 1) == b;
                        return c && s++, c
                    }, o = function(a) {
                        n(a);
                        var c = "@" == a ? 14 : "!" == a ? 20 : "y" == a ? 4 : "o" == a ? 3 : 2,
                            d = new RegExp("^\\d{1," + c + "}"),
                            e = b.substring(r).match(d);
                        if (!e) throw "Missing number at position " + r;
                        return r += e[0].length, parseInt(e[0], 10)
                    }, p = function(a, c, d) {
                        for (var e = n(a) ? d : c, f = 0; f < e.length; f++)
                            if (b.substr(r, e[f].length) == e[f]) return r += e[f].length, f + 1;
                ...
                if (-1 == i ? i = (new Date).getFullYear() : i < 100 && (i += (new Date).getFullYear() - (new Date).getFullYear() % 100 + (i <= d ? 0 : -100)), l > -1)
                    for (j = 1, k = l;;) {
            ...
            _determineDate: function(a, b, c) {
                var d = function(a) {
                    ...
                    e = function(b) {
                        ...
                        for (var c = (b.toLowerCase().match(/^c/) ? $.datepicker._getDate(a) : null) || new Date, d = c.getFullYear(), e = c.getMonth(), f = c.getDate(), g = /([+-]?[0-9]+)\s*(d|D|w|W|m|M|y|Y)?/g, h = g.exec(b); h;) {
                            switch (h[2] || "d") {
                                case "d":
                                case "D":
                                    f += parseInt(h[1], 10);
                ...
                return b = null == b ? c : "string" == typeof b ? e(b) : "number" == typeof b ? isNaN(b) ? c : d(b) : b, b = b && "Invalid Date" == b.toString() ? c : b, b && (b.setHours(0), b.setMinutes(0), b.setSeconds(0), b.setMilliseconds(0)), this._daylightSavingAdjust(b)
            },
            ...
            _generateHTML: function(a) {
                ...
                if (n < 0 && (n += 12, o--), m) {
                    ...
                    for (p = l && p < l ? l : p; this._daylightSavingAdjust(new Date(o, n, 1)) > p;) --n < 0 && (n = 11, o--)
                }
                ...
                for (var z = this._get(a, "showWeek"), A = this._get(a, "dayNames"), C = (this._get(a, "dayNamesShort"), this._get(a, "dayNamesMin")), D = this._get(a, "monthNames"), E = this._get(a, "monthNamesShort"), F = this._get(a, "beforeShowDay"), G = this._get(a, "showOtherMonths"), H = this._get(a, "selectOtherMonths"), J = (this._get(a, "calculateWeek") || this.iso8601Week, this._getDefaultDate(a)), K = "", L = 0; L < g[0]; L++) {
                    for (var M = "", N = 0; N < g[1]; N++) {
                        ...
                        for (var V = (this._getFirstDayOfMonth(o, n) - y + 7) % 7, W = j ? 6 : Math.ceil((V + U) / 7), X = this._daylightSavingAdjust(new Date(o, n, 1 - V)), Y = 0; Y < W; Y++) {
                            Q += "<tr>";
                            for (var Z = z ? '<td class="ui-datepicker-week-col">' + this._get(a, "calculateWeek")(X) + "</td>" : "", S = 0; S < 7; S++) {
                                var _ = F ? F.apply(a.input ? a.input[0] : null, [X]) : [!0, ""],
                                    aa = X.getMonth() != n,
                                    ba = aa && !H || !_[0] || l && X < l || m && X > m;
                                Z += '<td class="' + ((S + y + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (aa ? " ui-datepicker-other-month" : "") + (X.getTime() == O.getTime() && n == a.selectedMonth && a._keyEvent || J.getTime() == X.getTime() && J.getTime() == O.getTime() ? " " + this._dayOverClass : "") + (ba ? " " + this._unselectableClass + " ui-state-disabled" : "") + (aa && !G ? "" : " " + _[1] + (X.getTime() == k.getTime() ? " " + this._currentClass : "") + (X.getTime() == b.getTime() ? " ui-datepicker-today" : "")) + '"' + (aa && !G || !_[2] ? "" : ' title="' + _[2] + '"') + (ba ? "" : ' onclick="DP_jQuery_' + dpuuid + ".datepicker._selectDay('#" + a.id + "'," + X.getMonth() + "," + X.getFullYear() + ', this);return false;"') + ">" + (aa && !G ? "&#xa0;" : ba ? '<span class="ui-state-default">' + X.getDate() + "</span>" : '<a class="ui-state-default' + (X.getTime() == b.getTime() ? " ui-state-highlight" : "") + (X.getTime() == k.getTime() ? " ui-state-active" : "") + (aa ? " ui-priority-secondary" : "") + '" href="#">' + X.getDate() + "</a>") + "</td>", X.setDate(X.getDate() + 1), X = this._daylightSavingAdjust(X)
                            }
                            Q += Z + "</tr>"
                        }
            ...
            _generateMonthYearHeader: function(a, b, c, d, e, f, g, h) {
                ...
                if (k || (l += m + (!f && i && j ? "" : "&#xa0;")), f || !j) l += '<span class="ui-datepicker-year">' + c + "</span>";
                else {
                    var q = this._get(a, "yearRange").split(":"),
                        ...
                        t = s(q[0]),
                        u = Math.max(t, s(q[1] || ""));
                    for (t = d ? Math.max(t, d.getFullYear()) : t, u = e ? Math.min(u, e.getFullYear()) : u, l += '<select class="ui-datepicker-year" onchange="DP_jQuery_' + dpuuid + ".datepicker._selectMonthYear('#" + a.id + "', this, 'Y');\" onclick=\"DP_jQuery_" + dpuuid + ".datepicker._clickMonthYear('#" + a.id + "');\">"; t <= u; t++) l += '<option value="' + t + '"' + (t == c ? ' selected="selected"' : "") + ">" + t + "</option>";
                    l += "</select>"
                }
            ...
            _restrictMinMax: function(a, b) {
                ...
                return b = c && b < c ? c : b, b = d && b > d ? d : b
            },
        ...
        }, $.datepicker = new Datepicker, $.datepicker.initialized = !1, $.datepicker.uuid = (new Date).getTime(), $.datepicker.version = "1.8.2", window["DP_jQuery_" + dpuuid] = $
    }(jQuery),
    function(a) {
        ...
        a.widget("ui.dialog", {
            ...
            _create: function() {
                ...
                var c = this,
                    d = c.options,
                    e = d.title || c.originalTitle || "&#160;",
                    f = a.ui.dialog.getTitleId(c.element),
                    g = (c.uiDialog = a("<div></div>")).appendTo(document.body).hide().addClass(b + d.dialogClass).css({
                        zIndex: d.zIndex
                    ...
                    i = (c.element.show().removeAttr("title").addClass("ui-dialog-content ui-widget-content").appendTo(g), (c.uiDialogTitlebar = a("<div></div>")).addClass("ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix").prependTo(g)),
                ...
                (c.uiDialogTitlebarCloseText = a("<span></span>")).addClass("ui-icon ui-icon-closethick").text(d.closeText).appendTo(j), a("<span></span>").addClass("ui-dialog-title").attr("id", f).html(e).prependTo(i);
                a.isFunction(d.beforeclose) && !a.isFunction(d.beforeClose) && (d.beforeClose = d.beforeclose), i.find("*").add(i).disableSelection(), d.draggable && a.fn.draggable && c._makeDraggable(), d.resizable && a.fn.resizable && c._makeResizable(), c._createButtons(d.buttons), c._isOpen = !1, a.fn.bgiframe && g.bgiframe()
            },
            _init: function() {
            ...
            close: function(b) {
                ...
                if (!1 !== c._trigger("beforeClose", b)) return c.overlay && c.overlay.destroy(), c.uiDialog.unbind("keypress.ui-dialog"), c._isOpen = !1, c.options.hide ? c.uiDialog.hide(c.options.hide, function() {
                    ...
                    this !== c.uiDialog[0] && (d = Math.max(d, a(this).css("z-index")))
            ...
            open: function() {
                if (!this._isOpen) {
                    var b = this,
                        c = b.options,
                        d = b.uiDialog;
                    return b.overlay = c.modal ? new a.ui.dialog.overlay(b) : null, d.next().length && d.appendTo("body"), b._size(), b._position(c.position), d.show(c.show), b.moveToTop(!0), c.modal && d.bind("keypress.ui-dialog", function(b) {
                    ...
                    }), a([]).add(d.find(".ui-dialog-content :tabbable:first")).add(d.find(".ui-dialog-buttonpane :tabbable:first")).add(d).filter(":first").focus(), b._trigger("open"), b._isOpen = !0, b
                }
            },
            _createButtons: function(b) {
                ...
                c.uiDialog.find(".ui-dialog-buttonpane").remove(), "object" == typeof b && null !== b && a.each(b, function() {
                    ...
                    var f = a('<button type="button"></button>').text(b).click(function() {
            ...
            _makeResizable: function(b) {
                ...
                var c = this,
                    d = c.options,
                    e = c.uiDialog.css("position"),
                    f = "string" == typeof b ? b : "n,e,s,w,se,sw,ne,nw";
                c.uiDialog.resizable({
                    ...
                    handles: f,
                    start: function(b, d) {
                        a(this).addClass("ui-dialog-resizing"), c._trigger("resizeStart", b, g(d))
                    },
                    resize: function(a, b) {
                        c._trigger("resize", a, g(b))
                    },
                    stop: function(b, e) {
                        a(this).removeClass("ui-dialog-resizing"), d.height = a(this).height(), d.width = a(this).width(), c._trigger("resizeStop", b, g(e)), a.ui.dialog.overlay.resize()
                    }
            ...
            _position: function(b) {
                var e, c = [],
                    d = [0, 0];
                b = b || a.ui.dialog.prototype.options.position, "string" == typeof b || "object" == typeof b && "0" in b ? (c = b.split ? b.split(" ") : [b[0], b[1]], 1 === c.length && (c[1] = c[0]), a.each(["left", "top"], function(a, b) {
                    +c[a] === c[a] && (d[a] = c[a], c[a] = b)
                })) : "object" == typeof b && ("left" in b ? (c[0] = "left", d[0] = b.left) : "right" in b && (c[0] = "right", d[0] = -b.right), "top" in b ? (c[1] = "top", d[1] = b.top) : "bottom" in b && (c[1] = "bottom", d[1] = -b.bottom)), e = this.uiDialog.is(":visible"), e || this.uiDialog.show(), this.uiDialog.css({
                    top: 0,
                    left: 0
                }).position({
                    my: c.join(" "),
            ...
            _setOption: function(c, d) {
                ...
                switch (c) {
                    ...
                    case "closeText":
                        ...
                        break;
                    case "dialogClass":
                        f.removeClass(e.options.dialogClass).addClass(b + d);
                        break;
                    case "disabled":
                        d ? f.addClass("ui-dialog-disabled") : f.removeClass("ui-dialog-disabled");
                        break;
                    case "draggable":
                        d ? e._makeDraggable() : f.draggable("destroy");
                        break;
                    case "height":
                        h = !0;
                        break;
                    case "maxHeight":
                        g && f.resizable("option", "maxHeight", d), h = !0;
                        break;
                    case "maxWidth":
                        g && f.resizable("option", "maxWidth", d), h = !0;
                        break;
                    case "minHeight":
                        g && f.resizable("option", "minHeight", d), h = !0;
                        break;
                    case "minWidth":
                        g && f.resizable("option", "minWidth", d), h = !0;
                        break;
                    case "position":
                        e._position(d);
                        break;
                    case "resizable":
                        g && !d && f.resizable("destroy"), g && "string" == typeof d && f.resizable("option", "handles", d), g || !1 === d || e._makeResizable(d);
                        break;
                    case "title":
                ...
                a.Widget.prototype._setOption.apply(e, arguments), h && e._size()
            },
            _size: function() {
                ...
                this.element.css({
                    ...
                    height: "auto",
                    width: a.width
                }).height(), this.element.css("auto" === a.height ? {
            ...
            destroy: function(b) {
                this.oldInstances.push(this.instances.splice(a.inArray(b, this.instances), 1)[0]), 0 === this.instances.length && a([document, window]).unbind(".dialog-overlay"), b.remove();
                var c = 0;
    ...
    function(a) {
        ...
        a.fn.position = function(g) {
            ...
            g = a.extend({}, g);
            var k, l, m, h = a(g.of),
                i = (g.collision || "flip").split(" "),
                j = g.offset ? g.offset.split(" ") : [0, 0];
            return 9 === g.of.nodeType ? (k = h.width(), l = h.height(), m = {
                top: 0,
                left: 0
            }) : g.of.scrollTo && g.of.document ? (k = h.width(), l = h.height(), m = {
                top: h.scrollTop(),
                left: h.scrollLeft()
            }) : g.of.preventDefault ? (g.at = "left top", k = l = 0, m = {
                top: g.of.pageY,
                left: g.of.pageX
            }) : (k = h.outerWidth(), l = h.outerHeight(), m = h.offset()), a.each(["my", "at"], function() {
                var a = (g[this] || "").split(" ");
                1 === a.length && (a = b.test(a[0]) ? a.concat([e]) : d.test(a[0]) ? [c].concat(a) : [c, e]), a[0] = b.test(a[0]) ? a[0] : c, a[1] = d.test(a[1]) ? a[1] : e, g[this] = a
            }), 1 === i.length && (i[1] = i[0]), j[0] = parseInt(j[0], 10) || 0, 1 === j.length && (j[1] = j[0]), j[1] = parseInt(j[1], 10) || 0, "right" === g.at[0] ? m.left += k : g.at[0] === c && (m.left += k / 2), "bottom" === g.at[1] ? m.top += l : g.at[1] === e && (m.top += l / 2), m.left += j[0], m.top += j[1], this.each(function() {
                var b = a(this),
                    d = b.outerWidth(),
                    f = b.outerHeight(),
                    h = a.extend({}, m);
                "right" === g.my[0] ? h.left -= d : g.my[0] === c && (h.left -= d / 2), "bottom" === g.my[1] ? h.top -= f : g.my[1] === e && (h.top -= f / 2), h.left = parseInt(h.left), h.top = parseInt(h.top), a.each(["left", "top"], function(b, c) {
                    a.ui.position[i[b]] && a.ui.position[i[b]][c](h, {
                        targetWidth: k,
                        targetHeight: l,
                        elemWidth: d,
                        elemHeight: f,
                ...
                }), a.fn.bgiframe && b.bgiframe(), b.offset(a.extend(h, {
                    using: g.using
                }))
            })
        }, a.ui.position = {
            fit: {
                left: function(b, c) {
                    var d = a(window),
                        e = b.left + c.elemWidth - d.width() - d.scrollLeft();
                    b.left = e > 0 ? b.left - e : Math.max(0, b.left)
                },
                top: function(b, c) {
                    var d = a(window),
                        e = b.top + c.elemHeight - d.height() - d.scrollTop();
                    b.top = e > 0 ? b.top - e : Math.max(0, b.top)
                }
            },
            flip: {
                left: function(b, c) {
                    if ("center" !== c.at[0]) {
                        var d = a(window),
                            ...
                            g = -2 * c.offset[0];
                        b.left += b.left < 0 ? f + c.targetWidth + g : e > 0 ? f - c.targetWidth + g : 0
                    }
                },
                top: function(b, c) {
                    if ("center" !== c.at[1]) {
                        var d = a(window),
                            ...
                            h = -2 * c.offset[1];
                        b.top += b.top < 0 ? f + c.targetHeight + h : e > 0 ? f + g + h : 0
                    }
                }
            }
    ...
    function(a) {
        a.widget("ui.progressbar", {
            ...
            _setOption: function(b, c) {
                switch (b) {
                    case "value":
                        this.options.value = c, this._refreshValue(), this._trigger("change")
                }
                a.Widget.prototype._setOption.apply(this, arguments)
            },
            _value: function() {
            ...
            _refreshValue: function() {
                var a = this.value();
                this.valueDiv[a === this._valueMax() ? "addClass" : "removeClass"]("ui-corner-right").width(a + "%"), this.element.attr("aria-valuenow", a)
            }
    ...
    function(a) {
        ...
        a.widget("ui.slider", a.ui.mouse, {
            ...
            _create: function() {
                var c = this,
                    d = this.options;
                if (this._keySliding = !1, this._mouseSliding = !1, this._animateOff = !0, this._handleIndex = null, this._detectOrientation(), this._mouseInit(), this.element.addClass("ui-slider ui-slider-" + this.orientation + " ui-widget ui-widget-content ui-corner-all"), d.disabled && this.element.addClass("ui-slider-disabled ui-disabled"), this.range = a([]), d.range && (!0 === d.range ? (this.range = a("<div></div>"), d.values || (d.values = [this._valueMin(), this._valueMin()]), d.values.length && 2 !== d.values.length && (d.values = [d.values[0], d.values[0]])) : this.range = a("<div></div>"), this.range.appendTo(this.element).addClass("ui-slider-range"), "min" !== d.range && "max" !== d.range || this.range.addClass("ui-slider-range-" + d.range), this.range.addClass("ui-widget-header")), 0 === a(".ui-slider-handle", this.element).length && a("<a href='#'></a>").appendTo(this.element).addClass("ui-slider-handle"), d.values && d.values.length)
                    ...
                    if (!c.options.disabled) {
                        switch (d.keyCode) {
                            ...
                            case a.ui.keyCode.LEFT:
                                if (e = !1, !c._keySliding && (c._keySliding = !0, a(this).addClass("ui-state-active"), !1 === c._start(d, f))) return
                        }
                        switch (j = c.options.step, h = i = c.options.values && c.options.values.length ? c.values(f) : c.value(), d.keyCode) {
                            case a.ui.keyCode.HOME:
                                i = c._valueMin();
                                break;
                            case a.ui.keyCode.END:
                                ...
                                break;
                            case a.ui.keyCode.PAGE_UP:
                                i = c._trimAlignValue(h + (c._valueMax() - c._valueMin()) / b);
                                break;
                            case a.ui.keyCode.PAGE_DOWN:
                                i = c._trimAlignValue(h - (c._valueMax() - c._valueMin()) / b);
                                break;
            ...
            _mouseCapture: function(b) {
                var d, e, f, g, h, i, k, l, c = this.options;
                ...
                }), !0 === c.range && this.values(1) === c.min && (i += 1, g = a(this.handles[i])), !1 !== this._start(b, i) && (this._mouseSliding = !0, h._handleIndex = i, g.addClass("ui-state-active").focus(), k = g.offset(), l = !a(b.target).parents().andSelf().is(".ui-slider-handle"), this._clickOffset = l ? {
                    left: 0,
                    top: 0
                } : {
                    left: b.pageX - k.left - g.width() / 2,
                    top: b.pageY - k.top - g.height() / 2 - (parseInt(g.css("borderTopWidth"), 10) || 0) - (parseInt(g.css("borderBottomWidth"), 10) || 0) + (parseInt(g.css("marginTop"), 10) || 0)
                }, e = this._normValueFromMouse(d), this._slide(b, i, e), this._animateOff = !0, !0))
            },
            _mouseStart: function(a) {
                return !0
            },
            ...
            _refreshValue: function() {
                var f, h, i, j, k, b = this.options.range,
                    c = this.options,
                    d = this,
                    e = !this._animateOff && c.animate,
                    g = {};
                this.options.values && this.options.values.length ? this.handles.each(function(b, i) {
                    f = (d.values(b) - d._valueMin()) / (d._valueMax() - d._valueMin()) * 100, g["horizontal" === d.orientation ? "left" : "bottom"] = f + "%", a(this).stop(1, 1)[e ? "animate" : "css"](g, c.animate), !0 === d.options.range && ("horizontal" === d.orientation ? (0 === b && d.range.stop(1, 1)[e ? "animate" : "css"]({
                        left: f + "%"
                ...
                }) : (i = this.value(), j = this._valueMin(), k = this._valueMax(), f = k !== j ? (i - j) / (k - j) * 100 : 0, g["horizontal" === d.orientation ? "left" : "bottom"] = f + "%", this.handle.stop(1, 1)[e ? "animate" : "css"](g, c.animate), "min" === b && "horizontal" === this.orientation && this.range.stop(1, 1)[e ? "animate" : "css"]({
                    width: f + "%"
    ...
    function(a) {
        ...
        a.widget("ui.tabs", {
            ...
            _tabId: function(a) {
                return a.title && a.title.replace(/\s/g, "_").replace(/[^A-Za-z0-9\-_:\.]/g, "") || this.options.idPrefix + d()
            },
            _sanitizeSelector: function(a) {
                return a.replace(/:/g, "\\:")
            },
            _cookie: function() {
                var b = this.cookie || (this.cookie = this.options.cookie.name || "ui-tabs-" + e());
            ...
            _tabify: function(b) {
                ...
                var c = this,
                    d = this.options,
                    e = /^#.+/;
                this.anchors.each(function(b, f) {
                    var i, g = a(f).attr("href"),
                        h = g.split("#")[0];
                    if (h && (h === location.toString().split("#")[0] || (i = a("base")[0]) && h === i.href) && (g = f.hash, f.href = g), e.test(g)) c.panels = c.panels.add(c._sanitizeSelector(g));
                    else if ("#" != g) {
                        a.data(f, "href.tabs", g), a.data(f, "load.tabs", g.replace(/#.*$/, ""));
                        var j = c._tabId(f);
                        f.href = "#" + j;
                        var k = a("#" + j);
                        k.length || (k = a(d.panelTemplate).attr("id", j).addClass("ui-tabs-panel ui-widget-content ui-corner-bottom").insertAfter(c.panels[b - 1] || c.list), k.data("destroy.tabs", !0)), c.panels = c.panels.add(k)
                    } else d.disabled.push(b)
                    ...
                    if (b.hash == location.hash) return d.selected = a, !1
                }), "number" != typeof d.selected && d.cookie && (d.selected = parseInt(c._cookie(), 10)), "number" != typeof d.selected && this.lis.filter(".ui-tabs-selected").length && (d.selected = this.lis.index(this.lis.filter(".ui-tabs-selected"))), d.selected = d.selected || (this.lis.length ? 0 : -1)) : null === d.selected && (d.selected = -1), d.selected = d.selected >= 0 && this.anchors[d.selected] || d.selected < 0 ? d.selected : 0, d.disabled = a.unique(d.disabled.concat(a.map(this.lis.filter(".ui-state-disabled"), function(a, b) {
                    return c.lis.index(a)
                }))).sort(), -1 != a.inArray(d.selected, d.disabled) && d.disabled.splice(a.inArray(d.selected, d.disabled), 1), this.panels.addClass("ui-tabs-hide"), this.lis.removeClass("ui-tabs-selected ui-state-active"), d.selected >= 0 && this.anchors.length && (this.panels.eq(d.selected).removeClass("ui-tabs-hide"), this.lis.eq(d.selected).addClass("ui-tabs-selected ui-state-active"), c.element.queue("tabs", function() {
                    c._trigger("show", null, c._ui(c.anchors[d.selected], c.panels[d.selected]))
                }), this.load(d.selected)), a(window).bind("unload", function() {
                    c.lis.add(c.anchors).unbind(".tabs"), c.lis = c.anchors = c.panels = null
                })) : d.selected = this.lis.index(this.lis.filter(".ui-tabs-selected")), this.element[d.collapsible ? "addClass" : "removeClass"]("ui-tabs-collapsible"), d.cookie && this._cookie(d.selected, d.cookie);
                for (var g, f = 0; g = this.lis[f]; f++) a(g)[-1 == a.inArray(f, d.disabled) || a(g).hasClass("ui-tabs-selected") ? "removeClass" : "addClass"]("ui-state-disabled");
                if (!1 === d.cache && this.anchors.removeData("cache.tabs"), this.lis.add(this.anchors).unbind(".tabs"), "mouseover" != d.event) {
                    var h = function(a, b) {
                ...
                var j, k;
                d.fx && (a.isArray(d.fx) ? (j = d.fx[0], k = d.fx[1]) : j = k = d.fx);
                var m = k ? function(b, d) {
                        a(b).closest("li").addClass("ui-tabs-selected ui-state-active"), d.hide().removeClass("ui-tabs-hide").animate(k, k.duration || "normal", function() {
                            l(d, k), c._trigger("show", null, c._ui(b, d[0]))
                        })
                    } : function(b, d) {
                        a(b).closest("li").addClass("ui-tabs-selected ui-state-active"), d.removeClass("ui-tabs-hide"), c._trigger("show", null, c._ui(b, d[0]))
                    },
                    n = j ? function(a, b) {
                        b.animate(j, j.duration || "normal", function() {
                            c.lis.removeClass("ui-tabs-selected ui-state-active"), b.addClass("ui-tabs-hide"), l(b, j), c.element.dequeue("tabs")
                        })
                    } : function(a, b, d) {
                        c.lis.removeClass("ui-tabs-selected ui-state-active"), b.addClass("ui-tabs-hide"), c.element.dequeue("tabs")
                    };
                this.anchors.bind(d.event + ".tabs", function() {
                    var b = this,
                        e = a(this).closest("li"),
                        f = c.panels.filter(":not(.ui-tabs-hide)"),
                        g = a(c._sanitizeSelector(this.hash));
                    if (e.hasClass("ui-tabs-selected") && !d.collapsible || e.hasClass("ui-state-disabled") || e.hasClass("ui-state-processing") || !1 === c._trigger("select", null, c._ui(this, g[0]))) return this.blur(), !1;
                    if (d.selected = c.anchors.index(this), c.abort(), d.collapsible) {
                        if (e.hasClass("ui-tabs-selected")) return d.selected = -1, d.cookie && c._cookie(d.selected, d.cookie), c.element.queue("tabs", function() {
                            n(b, f)
                        }).dequeue("tabs"), this.blur(), !1;
                        if (!f.length) return d.cookie && c._cookie(d.selected, d.cookie), c.element.queue("tabs", function() {
                            m(b, g)
                        }), c.load(c.anchors.index(this)), this.blur(), !1
                    }
                    if (d.cookie && c._cookie(d.selected, d.cookie), !g.length) throw "jQuery UI Tabs: Mismatching fragment identifier.";
                    f.length && c.element.queue("tabs", function() {
                        n(b, f)
                    }), c.element.queue("tabs", function() {
                        m(b, g)
                    }), c.load(c.anchors.index(this)), a.browser.msie && this.blur()
            ...
            add: function(b, c, d) {
                void 0 === d && (d = this.anchors.length);
                var e = this,
                    f = this.options,
                    g = a(f.tabTemplate.replace(/#\{href\}/g, b).replace(/#\{label\}/g, c)),
                    h = b.indexOf("#") ? this._tabId(a("a", g)[0]) : b.replace("#", "");
                g.addClass("ui-state-default ui-corner-top").data("destroy.tabs", !0);
                var i = a("#" + h);
                return i.length || (i = a(f.panelTemplate).attr("id", h).data("destroy.tabs", !0)), i.addClass("ui-tabs-panel ui-widget-content ui-corner-bottom ui-tabs-hide"), d >= this.lis.length ? (g.appendTo(this.list), i.appendTo(this.list[0].parentNode)) : (g.insertBefore(this.lis[d]), i.insertBefore(this.panels[d])), f.disabled = a.map(f.disabled, function(a, b) {
                    return a >= d ? ++a : a
                }), this._tabify(), 1 == this.anchors.length && (f.selected = 0, g.addClass("ui-tabs-selected ui-state-active"), i.removeClass("ui-tabs-hide"), this.element.queue("tabs", function() {
                    e._trigger("show", null, e._ui(e.anchors[0], e.panels[0]))
                }), this.load(0)), this._trigger("add", null, this._ui(this.anchors[d], this.panels[d])), this
            },
            remove: function(b) {
                var c = this.options,
            ...
            load: function(b) {
                ...
                return this.xhr = a.ajax(a.extend({}, d.ajaxOptions, {
                    ...
                    success: function(f, g) {
                        a(c._sanitizeSelector(e.hash)).html(f), c._cleanup(), d.cache && a.data(e, "cache.tabs", !0), c._trigger("load", null, c._ui(c.anchors[b], c.panels[b]));
                        try {
